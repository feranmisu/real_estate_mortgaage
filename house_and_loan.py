...
def main():
    ...
    if (ms == 'FV'):
        ...
        MSZoning = 0
    st.write('RL = Residential Low Density RM = Residential Medium Density RH = Residential High Density FV = FLoating Village Residential c = Commercial user selected ', ms)
